...
const BASE_URI = encodeURIComponent(
  process.env.NODE_ENV === "production"
    ? "https://twitch-rewards-todo-crystalcastles.vercel.app/"
    : "https://twitch-rewards-todo-crystalcastles.vercel.app/"
...
const REDIRECT_URI = encodeURIComponent(
  process.env.NODE_ENV === "production"
    ? "https://twitch-rewards-todo-crystalcastles.vercel.app/auth/twitch"
    : "https://twitch-rewards-todo-crystalcastles.vercel.app/auth/twitch"
    ...
    fetch(`${TWITCH_API_URL}/eventsub/subscriptions`, {
      ...
      body: JSON.stringify({
        ...
        transport: {
          ...
          callback: "https://twitch-rewards-todo-crystalcastles.vercel.app/api/webhooks/callbacks/subscription",
